...
func f1() {
	...
	// 2019/12/30 11:55:02 AM
	fmt.Println(now.Format("2006/01/02 03:04:05 PM"))
	// 2019/12/30 11:55:02.342
...
func f2() {
	...
	// 明天的这个时间
	// 按照指定格式取一个字符串格式的时间
	time.Parse("2006-01-02 15:04:05", "2019-12-31 15:04:05")
	...
	timeObj, err := time.ParseInLocation("2006-01-02 15:04:05", "2019-12-31 15:04:05", loc)
	if err != nil {
		fmt.Printf("parse time failed, err:%v\n", err)
		return
	}
	fmt.Println(timeObj)
	fmt.Println(time.ParseInLocation("2006-01-02 15:04:05", "2019-12-31 15:04:05", time.Local))
	// 时间对象相减
	td := timeObj.Sub(now)
	fmt.Println(td)
}
